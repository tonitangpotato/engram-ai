...
impl ActiveContext {
    ...
    pub fn prune(&mut self) {
        ...
        self.items
            .retain(|_, activated_at| now.duration_since(*activated_at) < self.decay_duration);
...
impl SessionRegistry {
    ...
    pub fn get_session(&mut self, session_id: &str) -> &mut ActiveContext {
        self.sessions
            ...
            .or_insert_with(|| ActiveContext::new(self.default_capacity, self.default_decay_secs))
    }
