#!/usr/bin/env python3
"""
RUN-0005: LoCoMo conv-26 sessions 1-3 ingest, post ISS-068 fix.

Commit 6f5821a: store_raw now persists raw memory + records
graph_extraction_failures when extractor returns no facts,
instead of silently skipping.

Expectation: 50/50 turns admitted (vs 31/50 in RUN-0004 substrate).

Output: locomo-conv26-iss068.{db,graph.db}
...
OUT_DIR = Path("/Users/potato/clawd/projects/engram/.gid/eval-runs/RUN-0005-substrate")
DB_PATH = OUT_DIR / "locomo-conv26-iss068.db"
GRAPH_DB_PATH = OUT_DIR / "locomo-conv26-iss068.graph.db"
