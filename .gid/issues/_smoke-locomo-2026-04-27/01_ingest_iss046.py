#!/usr/bin/env python3
"""
LoCoMo conv-26 sessions 1-3 ingest, post ISS-046 fix
(commits b806485 + 950159d: --graph-db wiring + 3 engramai bug fixes).

Adds --graph-db flag to engram store so v0.3 ResolutionPipeline runs
on every ingest. Output graph DB co-located with main DB.

Output: locomo-conv26-s1-3-iss046.db + .graph.db
"""
...
DB_PATH = OUT_DIR / "locomo-conv26-s1-3-iss046.db"
GRAPH_DB_PATH = OUT_DIR / "locomo-conv26-s1-3-iss046.graph.db"
LOG_PATH = OUT_DIR / "ingest_iss046.log"
NAMESPACE = "locomo-conv26-iss046"
